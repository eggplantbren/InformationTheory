...
\node[lattice node] (ab) at (-5,4) {$a \vee b$};
\node[lattice node] (ac) at (-3,4) {$a \vee c$};
\node[lattice node] (ad) at (-1,4) {$a \vee d$};
\node[lattice node] (bc) at (1,4)  {$b \vee c$};
\node[lattice node] (bd) at (3,4)  {$b \vee d$};
\node[lattice node] (cd) at (5,4)  {$c \vee d$};
